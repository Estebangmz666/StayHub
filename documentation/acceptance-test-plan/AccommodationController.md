...
![create_accommodation_body](/documentation/assets/create_accommodation_body.png)
![create_accommodation_headers](/documentation/assets/create_accommodation_headers.png)

**Obtained Result:**  
Received the expected HTTP 201 code.  

![create_accommodation_response](/documentation/assets/create_accommodation_response.png)

Validate the created data in the database (accommodation table in MariaDB).  

![create_accommodation_db](/documentation/assets/create_accommodation_db.png)
...
![get_accommodation_by_id_request](/documentation/assets/get_accommodation_by_id_request.png)

**Obtained Result:**  
Received the expected HTTP 200 code.  

![get_accommodation_by_id_response](/documentation/assets/get_accommodation_by_id_response.png) 
...
![update_accommodation_body](/documentation/assets/update_accommodation_body.png)
![update_accommodation_headers](/documentation/assets/update_accommodation_headers.png)

**Obtained Result:**  
Received the expected HTTP 200 code.  

![update_accommodation_response](/documentation/assets/update_accommodation_response.png)

Validate the updated data in the database.  

![update_accommodation_db](/documentation/assets/update_accommodation_db.png)
...
![search_accommodation_filters_request](/documentation/assets/search_accommodation_filters_request.png)

**Obtained Result:**  
Received the expected HTTP 200 code.  

![search_accommodation_filters_response](/documentation/assets/search_accommodation_filters_response.png)
...
![delete_accommodation_request](/documentation/assets/delete_accommodation_request.png)

**Obtained Result:**  
Received the expected HTTP 200 code.  

![delete_accommodation_response](/documentation/assets/delete_accommodation_response.png)

Validate the data in the database (ensure isDeleted = 1).  

![delete_accommodation_db](/documentation/assets/delete_accommodation_db.png)
...
![list_accommodations_request](/documentation/assets/list_accommodations_request.png)

**Obtained Result:**  
Received the expected HTTP 200 code.  

![list_accommodations_response](/documentation/assets/list_accommodations_response.png)
